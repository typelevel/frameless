...
class NonAggregateFunctionsTests extends TypedDatasetSuite {
  ...
  test("negate") {
    ...
    def prop[A: TypedEncoder: Encoder, B: TypedEncoder: Encoder](values: List[X1[A]])(
      ...
      val resCompare =
        cDS.select(sparkFunctions.negate(cDS("a"))).map(_.getAs[B](0)).collect().toList
  ...
  test("not") {
    ...
    def prop(values: List[X1[Boolean]], fromBase: Int, toBase: Int)(
        implicit encX1: Encoder[X1[Boolean]]) = {
      val cDS = session.createDataset(values)

      val resCompare =
        cDS.select(sparkFunctions.not(cDS("a"))).map(_.getAs[Boolean](0)).collect().toList
  ...
  test("conv") {
    ...
    def prop(values: List[X1[String]], fromBase: Int, toBase: Int)(
        implicit encX1: Encoder[X1[String]]) = {
      val cDS = session.createDataset(values)
      ...
      val typedDS = TypedDataset.create(values)
      val col = typedDS('a)
      val res = typedDS.select(conv(col, fromBase, toBase)).collect().run().toList
  ...
  test("degrees") {
    ...
    def prop[A: TypedEncoder: Encoder](values: List[X1[A]])(implicit encX1: Encoder[X1[A]]) = {
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.degrees(cDS("a"))).map(_.getAs[Double](0)).collect().toList
  ...
  def propBitShift[A: TypedEncoder: Encoder, B: TypedEncoder: Encoder](
    ...
    val resCompare =
      typedDS.dataset.select(sparkFunc($"a", numBits)).map(_.getAs[B](0)).collect().toList
  ...
  test("shiftRightUnsigned") {
    ...
    def prop[A: TypedEncoder: Encoder, B: TypedEncoder: Encoder](
        values: List[X1[A]],
        numBits: Int)(
        implicit catalystBitShift: CatalystBitShift[A, B],
        encX1: Encoder[X1[A]]) = {
      val typedDS = TypedDataset.create(values)
  ...
  test("ceil") {
    ...
    def prop[A: TypedEncoder: Encoder, B: TypedEncoder: Encoder](values: List[X1[A]])(
        implicit catalystAbsolute: CatalystRound[A, B],
        encX1: Encoder[X1[A]]
    ) = {
      val cDS = session.createDataset(values)
      val resCompare = cDS
    ...
    def prop(values: List[X1[Array[Byte]]])(implicit encX1: Encoder[X1[Array[Byte]]]) = {
      Seq(224, 256, 384, 512)
        .map { numBits =>
          ...
          val typedDS = TypedDataset.create(values)
          val res = typedDS.select(sha2(typedDS('a), numBits)).collect().run().toList
          res ?= resCompare
        }
        .reduce(_ && _)
    }
  ...
  test("sha1") {
    ...
    def prop(values: List[X1[Array[Byte]]])(implicit encX1: Encoder[X1[Array[Byte]]]) = {
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.sha1(cDS("a"))).map(_.getAs[String](0)).collect().toList
  ...
  test("crc32") {
    ...
    def prop(values: List[X1[Array[Byte]]])(implicit encX1: Encoder[X1[Array[Byte]]]) = {
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.crc32(cDS("a"))).map(_.getAs[Long](0)).collect().toList
  ...
  test("abs big decimal") {
    ...
    def prop[A: TypedEncoder: Encoder, B: TypedEncoder: Encoder](values: List[X1[A]])(
      ...
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.abs(cDS("a"))).map(_.getAs[B](0)).collect().toList
  ...
  test("abs") {
    ...
    def prop[A: TypedEncoder: Encoder](values: List[X1[A]])(
      ...
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.abs(cDS("a"))).map(_.getAs[A](0)).collect().toList
  ...
  test("arrayContains") {
    ...
    def prop[C[_]: CatalystCollection](values: C[Int], shouldBeIn: Boolean)(
      ...
      val res = typedDS.select(arrayContains(typedDS('a), contained)).collect().run().toList
  ...
  test("atan") {
    ...
    def prop[A: CatalystNumeric: TypedEncoder: Encoder](na: A, values: List[X1[A]])(
        implicit encX1: Encoder[X1[A]]) = {
  ...
  test("atan2LitLeft") {
    ...
    def prop[A: CatalystNumeric: TypedEncoder: Encoder](
        na: X1[A],
        value: List[X1[A]],
        lit: Double)(implicit encX1: Encoder[X1[A]]) = {
  ...
  test("round") {
    ...
    def prop[A: TypedEncoder: Encoder](values: List[X1[A]])(
      ...
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.round(cDS("a"))).map(_.getAs[A](0)).collect().toList
  ...
  test("round with scale") {
    ...
    def prop[A: TypedEncoder: Encoder](values: List[X1[A]])(
      ...
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.round(cDS("a"), 1)).map(_.getAs[A](0)).collect().toList
  ...
  test("bround") {
    ...
    def prop[A: TypedEncoder: Encoder](values: List[X1[A]])(
      ...
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.bround(cDS("a"))).map(_.getAs[A](0)).collect().toList
  ...
  test("bround with scale") {
    ...
    def prop[A: TypedEncoder: Encoder](values: List[X1[A]])(
      ...
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.bround(cDS("a"), 1)).map(_.getAs[A](0)).collect().toList
  ...
  test("base64") {
    ...
    def prop(values: List[X1[Array[Byte]]])(implicit encX1: Encoder[X1[Array[Byte]]]) = {
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.base64(cDS("a"))).map(_.getAs[String](0)).collect().toList

      val typedDS = TypedDataset.create(values)
      val res = typedDS.select(base64(typedDS('a))).collect().run().toList

      val backAndForth =
        typedDS.select(base64(unbase64(base64(typedDS('a))))).collect().run().toList
  ...
  test("pmod") {
    ...
    def prop[A: CatalystNumeric: TypedEncoder: Encoder](
      ...
      val res = typedDS.select(pmod(typedDS('b), typedDS('a))).collect().run().toList
  ...
  test("bin") {
    ...
    def prop(values: List[X1[Long]])(implicit encX1: Encoder[X1[Long]]) = {
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.bin(cDS("a"))).map(_.getAs[String](0)).collect().toList
  ...
  test("bitwiseNOT") {
    ...
    def prop[A: CatalystBitwise: TypedEncoder: Encoder](values: List[X1[A]])(
        implicit encX1: Encoder[X1[A]]) = {
      val cDS = session.createDataset(values)
      val resCompare =
        cDS.select(sparkFunctions.bitwiseNOT(cDS("a"))).map(_.getAs[A](0)).collect().toList
  ...
  test("monotonic id") {
    ...
    def prop[A: TypedEncoder](xs: List[X1[A]])(implicit x2en: Encoder[X2[A, Long]]) = {
      ...
      val result =
        ds.withColumn[X2[A, Long]](monotonicallyIncreasingId()).collect().run().toVector
  ...
  test("ascii") {
    ...
    check(forAll { values: List[X1[String]] =>
      ...
      val sparkResult =
        ds.toDF().select(sparkFunctions.ascii($"a")).map(_.getAs[Int](0)).collect().toVector
  ...
  test("concat for TypedAggregate") {
    ...
    check(forAll(pairs) { values: List[X2[String, String]] =>
      ...
      val spark = ds
        .dataset
        .select(sparkFunctions
          .concat(sparkFunctions.first($"a").as[String], sparkFunctions.first($"b").as[String]))
        .as[String]
        .collect()
        .toVector
      td ?= spark
  ...
  test("concat_ws") {
    ...
    check(forAll(pairs) { values: List[X2[String, String]] =>
      ...
      val typed = ds.select(concatWs(",", ds('a), ds('b))).collect().run().toVector
  ...
  test("length") {
    ...
    check(forAll { values: List[X1[String]] =>
      ...
      val sparkResult =
        ds.toDF().select(sparkFunctions.length($"a")).map(_.getAs[Int](0)).collect().toVector
  ...
  test("levenshtein") {
    ...
    check(forAll { (na: X1[String], values: List[X1[String]]) =>
      ...
      val sparkResult = ds
        .toDF()
        .select(sparkFunctions
          .levenshtein($"a", sparkFunctions.concat($"a", sparkFunctions.lit("Hello"))))
        .map(_.getAs[Int](0))
        .collect()
        .toVector

      val typed =
        ds.select(levenshtein(ds('a), concat(ds('a), lit("Hello")))).collect().run().toVector
  ...
  test("regexp_replace") {
    ...
    check(forAll { (values: List[X1[String]], n: Int) =>
      ...
      val typed =
        ds.select(regexpReplace(ds[String]('a), "\\d+".r, "n")).collect().run().toVector
  ...
  test("rpad") {
    ...
    check(forAll { values: List[X1[String]] =>
      ...
      val typed = ds.select(rpad(ds[String]('a), 5, "hello")).collect().run().toVector
  ...
  test("lpad") {
    ...
    check(forAll { values: List[X1[String]] =>
      ...
      val typed = ds.select(lpad(ds[String]('a), 5, "hello")).collect().run().toVector
  ...
  test("rtrim") {
    ...
    check(forAll { values: List[X1[String]] =>
      ...
      val sparkResult =
        ds.toDF().select(sparkFunctions.rtrim($"a")).map(_.getAs[String](0)).collect().toVector
  ...
  test("ltrim") {
    ...
    check(forAll { values: List[X1[String]] =>
      ...
      val sparkResult =
        ds.toDF().select(sparkFunctions.ltrim($"a")).map(_.getAs[String](0)).collect().toVector
  ...
  test("substring") {
    ...
    check(forAll { values: List[X1[String]] =>
      ...
      val typed = ds.select(substring(ds[String]('a), 5, 3)).collect().run().toVector
  ...
  test("trim") {
    ...
    check(forAll { values: List[X1[String]] =>
      ...
      val sparkResult =
        ds.toDF().select(sparkFunctions.trim($"a")).map(_.getAs[String](0)).collect().toVector
  ...
  test("upper") {
    ...
    check(forAll(Gen.listOf(Gen.alphaStr)) { values: List[String] =>
      ...
      val sparkResult =
        ds.toDF().select(sparkFunctions.upper($"a")).map(_.getAs[String](0)).collect().toVector
  ...
  test("lower") {
    ...
    check(forAll(Gen.listOf(Gen.alphaStr)) { values: List[String] =>
      ...
      val sparkResult =
        ds.toDF().select(sparkFunctions.lower($"a")).map(_.getAs[String](0)).collect().toVector
  ...
  test("Empty vararg tests") {
    def prop[A: TypedEncoder, B: TypedEncoder](data: Vector[X2[A, B]]) = {
      ...
      val frameless =
        ds.select(ds('a), concat(), ds('b), concatWs(":")).collect().run().toVector
