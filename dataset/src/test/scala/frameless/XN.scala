...
object X3U {
  implicit def arbitrary[A: Arbitrary, B: Arbitrary, C: Arbitrary]: Arbitrary[X3U[A, B, C]] =
    Arbitrary(
      Arbitrary.arbTuple3[A, B, C].arbitrary.map(x => X3U[A, B, C](x._1, x._2, (), x._3)))

  implicit def cogen[A, B, C](
      implicit A: Cogen[A],
      B: Cogen[B],
      C: Cogen[C]): Cogen[X3U[A, B, C]] =
    Cogen.tuple3(A, B, C).contramap(x => (x.a, x.b, x.c))
...
object X4 {
  implicit def arbitrary[A: Arbitrary, B: Arbitrary, C: Arbitrary, D: Arbitrary]
  ...
  implicit def cogen[A, B, C, D](
      ...
      B: Cogen[B],
      C: Cogen[C],
      D: Cogen[D]): Cogen[X4[A, B, C, D]] =
    Cogen.tuple4(A, B, C, D).contramap(x => (x.a, x.b, x.c, x.d))

  implicit def ordering[A: Ordering, B: Ordering, C: Ordering, D: Ordering]
      : Ordering[X4[A, B, C, D]] =
...
object X5 {
  implicit def arbitrary[A: Arbitrary, B: Arbitrary, C: Arbitrary, D: Arbitrary, E: Arbitrary]
      : Arbitrary[X5[A, B, C, D, E]] =
    Arbitrary(
      Arbitrary.arbTuple5[A, B, C, D, E].arbitrary.map((X5.apply[A, B, C, D, E] _).tupled))
  ...
  implicit def cogen[A, B, C, D, E](
      ...
      C: Cogen[C],
      D: Cogen[D],
      E: Cogen[E]): Cogen[X5[A, B, C, D, E]] =
    Cogen.tuple5(A, B, C, D, E).contramap(x => (x.a, x.b, x.c, x.d, x.e))

  implicit def ordering[A: Ordering, B: Ordering, C: Ordering, D: Ordering, E: Ordering]
...
object X6 {
  implicit def arbitrary[
      ...
      D: Arbitrary,
      E: Arbitrary,
      F: Arbitrary]: Arbitrary[X6[A, B, C, D, E, F]] =
    Arbitrary(
      Arbitrary
  ...
  implicit def cogen[A, B, C, D, E, F](
      ...
      D: Cogen[D],
      E: Cogen[E],
      F: Cogen[F]): Cogen[X6[A, B, C, D, E, F]] =
  ...
  implicit def ordering[
      ...
      D: Ordering,
      E: Ordering,
      F: Ordering]: Ordering[X6[A, B, C, D, E, F]] =
