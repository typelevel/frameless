...
abstract class AbstractTypedColumn[T, U](val expr: Expression)(
  ...
  trait Mapper[X] {
    def map[G, OutputType[_, _]](u: ThisType[T, X] => OutputType[T, G])(
        implicit
        ev: OutputType[T, G] <:< AbstractTypedColumn[T, G]): OutputType[T, Option[G]] = {
  ...
  private def equalsTo[TT, W](other: ThisType[TT, U])(
      implicit w: With.Aux[T, TT, W]): ThisType[W, Boolean] = typed {
   ...
   * }}}
   */
  def getOrElse[TT, W, Out](default: ThisType[TT, Out])(
      implicit i0: U =:= Option[Out],
      i1: With.Aux[T, TT, W]): ThisType[W, Out] =
   ...
   * }}}
   */
  def getOrElse[Out: TypedEncoder](default: Out)(
      implicit i0: U =:= Option[Out]): ThisType[T, Out] =
   ...
   * apache/spark
   */
  def plus[TT, W](other: ThisType[TT, U])(
      implicit n: CatalystNumeric[U],
      w: With.Aux[T, TT, W]): ThisType[W, U] =
   ...
   * apache/spark
   */
  def minus[TT, W](other: ThisType[TT, U])(
      implicit n: CatalystNumeric[U],
      w: With.Aux[T, TT, W]): ThisType[W, U] =
   ...
   * apache/spark
   */
  def multiply[TT, W](other: ThisType[TT, U])(
      implicit n: CatalystNumeric[U],
      w: With.Aux[T, TT, W],
      t: ClassTag[U]): ThisType[W, U] = typed {
   ...
   * apache/spark
   */
  def mod[Out: TypedEncoder, TT, W](other: ThisType[TT, U])(
      implicit n: CatalystNumeric[U],
      w: With.Aux[T, TT, W]): ThisType[W, Out] =
   ...
   * apache/spark
   */
  def divide[Out: TypedEncoder, TT, W](other: ThisType[TT, U])(
      implicit n: CatalystDivisible[U, Out],
      w: With.Aux[T, TT, W]): ThisType[W, Out] =
   ...
   * apache/spark
   */
  def /[Out, TT, W](other: ThisType[TT, U])(
      implicit n: CatalystDivisible[U, Out],
      e: TypedEncoder[Out],
      w: With.Aux[T, TT, W]): ThisType[W, Out] =
    divide(other)
   ...
   * apache/spark
   */
  def bitwiseAND[TT, W](other: ThisType[TT, U])(
      implicit n: CatalystBitwise[U],
      w: With.Aux[T, TT, W]): ThisType[W, U] =
   ...
   * apache/spark
   */
  def bitwiseOR[TT, W](other: ThisType[TT, U])(
      implicit n: CatalystBitwise[U],
      w: With.Aux[T, TT, W]): ThisType[W, U] =
   ...
   * apache/spark
   */
  def bitwiseXOR[TT, W](other: ThisType[TT, U])(
      implicit n: CatalystBitwise[U],
      w: With.Aux[T, TT, W]): ThisType[W, U] =
   ...
   * apache/spark
   */
  def contains[TT, W](other: ThisType[TT, U])(
      implicit ev: U =:= String,
      w: With.Aux[T, TT, W]): ThisType[W, Boolean] =
   ...
   * apache/spark
   */
  def startsWith[TT, W](other: ThisType[TT, U])(
      implicit ev: U =:= String,
      w: With.Aux[T, TT, W]): ThisType[W, Boolean] =
   ...
   * apache/spark
   */
  def endsWith[TT, W](other: ThisType[TT, U])(
      implicit ev: U =:= String,
      w: With.Aux[T, TT, W]): ThisType[W, Boolean] =
   ...
   * }}}
   */
  def and[TT, W](other: ThisType[TT, Boolean])(
      implicit w: With.Aux[T, TT, W]): ThisType[W, Boolean] =
   ...
   * }}}
   */
  def &&[TT, W](other: ThisType[TT, Boolean])(
      implicit w: With.Aux[T, TT, W]): ThisType[W, Boolean] =
    and(other)
   ...
   * }}}
   */
  def or[TT, W](other: ThisType[TT, Boolean])(
      implicit w: With.Aux[T, TT, W]): ThisType[W, Boolean] =
   ...
   * apache/spark
   */
  def between(lowerBound: U, upperBound: U)(
      implicit i0: CatalystOrdered[U]): ThisType[T, Boolean] =
    typed(self
      .untyped
      .between(lit(lowerBound)(self.uencoder).untyped, lit(upperBound)(self.uencoder).untyped))
  ...
  def between[TT1, TT2, W1, W2](lowerBound: ThisType[TT1, U], upperBound: ThisType[TT2, U])(
      ...
      w1: With.Aux[TT2, W1, W2]): ThisType[W2, Boolean] =
   ...
   */
  def field[V](symbol: Witness.Lt[Symbol])(
      implicit i0: TypedColumn.Exists[U, symbol.T, V],
      i1: TypedEncoder[V]): ThisType[T, V] =
...
object SortedTypedColumn {
  implicit def defaultAscending[T, U: CatalystOrdered](
      typedColumn: TypedColumn[T, U]): SortedTypedColumn[T, U] =
...
object TypedColumn {
  ...
  object ExistsMany {
    implicit def deriveCons[T, KH, KT <: HList, V0, V1](
        implicit head: Exists[T, KH, V0],
        tail: ExistsMany[V0, KT, V1]): ExistsMany[T, KH :: KT, V1] =
      new ExistsMany[T, KH :: KT, V1] {}

    implicit def deriveHNil[T, K, V](
        implicit head: Exists[T, K, V]): ExistsMany[T, K :: HNil, V] =
      new ExistsMany[T, K :: HNil, V] {}
  }

  object Exists {
    def apply[T, V](column: Witness)(
        implicit e: Exists[T, column.T, V]): Exists[T, column.T, V] = e

    implicit def deriveRecord[T, H <: HList, K, V](
        implicit i0: LabelledGeneric.Aux[T, H],
        i1: Selector.Aux[H, K, V]): Exists[T, K, V] = new Exists[T, K, V] {}
  }
