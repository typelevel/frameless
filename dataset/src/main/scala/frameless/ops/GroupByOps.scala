...
class GroupedByManyOps[T, TK <: HList, K <: HList, KT](self: TypedDataset[T], groupedBy: TK)(
  ...
  object agg extends ProductArgs {
    def applyProduct[TC <: HList, C <: HList, Out0 <: HList, Out1](columns: TC)(
        implicit i3: AggregateTypes.Aux[T, TC, C],
        i4: Prepend.Aux[K, C, Out0],
        i5: Tupler.Aux[Out0, Out1],
        i6: TypedEncoder[Out1],
        i7: ToTraversable.Aux[TC, List, UntypedExpression[T]]): TypedDataset[Out1] = {
...
class GroupedBy1Ops[K1, V](
  ...
  def agg[U1, U2](
      ...
      c2: TypedAggregate[V, U2]): TypedDataset[(K1, U1, U2)] = {
  ...
  def agg[U1, U2, U3](
      ...
      c3: TypedAggregate[V, U3]): TypedDataset[(K1, U1, U2, U3)] = {
  ...
  def agg[U1, U2, U3, U4](
      ...
      c4: TypedAggregate[V, U4]): TypedDataset[(K1, U1, U2, U3, U4)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder; implicit val e3 = c3.uencoder;
    implicit val e4 = c4.uencoder
  ...
  def agg[U1, U2, U3, U4, U5](
      ...
      c5: TypedAggregate[V, U5]): TypedDataset[(K1, U1, U2, U3, U4, U5)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder; implicit val e3 = c3.uencoder;
    implicit val e4 = c4.uencoder; implicit val e5 = c5.uencoder
  ...
  object deserialized {
    ...
    def flatMapGroups[U: TypedEncoder](
        f: (K1, Iterator[V]) => TraversableOnce[U]): TypedDataset[U] = {
      underlying.deserialized.flatMapGroups(AggregatingOps.tuple1(f))
    }
  }

  def pivot[P: CatalystPivotable](
      pivotColumn: TypedColumn[V, P]): PivotNotValues[V, TypedColumn[V, K1] :: HNil, P] =
...
class GroupedBy2Ops[K1, K2, V](
  ...
  def agg[U1, U2](
      c1: TypedAggregate[V, U1],
      c2: TypedAggregate[V, U2]): TypedDataset[(K1, K2, U1, U2)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder
    underlying.agg(c1, c2)
  }
  ...
  def agg[U1, U2, U3](
      c1: TypedAggregate[V, U1],
      c2: TypedAggregate[V, U2],
      c3: TypedAggregate[V, U3]): TypedDataset[(K1, K2, U1, U2, U3)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder; implicit val e3 = c3.uencoder
    underlying.agg(c1, c2, c3)
  }
  ...
  def agg[U1, U2, U3, U4](
      ...
      c2: TypedAggregate[V, U2],
      c3: TypedAggregate[V, U3],
      c4: TypedAggregate[V, U4]): TypedDataset[(K1, K2, U1, U2, U3, U4)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder; implicit val e3 = c3.uencoder;
    implicit val e4 = c4.uencoder
    underlying.agg(c1, c2, c3, c4)
  }
  ...
  def agg[U1, U2, U3, U4, U5](
      ...
      c3: TypedAggregate[V, U3],
      c4: TypedAggregate[V, U4],
      c5: TypedAggregate[V, U5]): TypedDataset[(K1, K2, U1, U2, U3, U4, U5)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder; implicit val e3 = c3.uencoder;
    implicit val e4 = c4.uencoder; implicit val e5 = c5.uencoder
    underlying.agg(c1, c2, c3, c4, c5)
  }
  ...
  object deserialized {
    ...
    def flatMapGroups[U: TypedEncoder](
        f: ((K1, K2), Iterator[V]) => TraversableOnce[U]): TypedDataset[U] = {
...
private[ops] abstract class AggregatingOps[T, TK <: HList, K <: HList, KT](
  ...
  def aggregate[TC <: HList, Out1](columns: TC)(
      implicit i7: TypedEncoder[Out1],
      i8: ToTraversable.Aux[TC, List, UntypedExpression[T]]): TypedDataset[Out1] = {
...
final case class Pivot[T, GroupedColumns <: HList, PivotType, Values <: HList](
  ...
  object agg extends ProductArgs {
    def applyProduct[
        ...
        implicit i0: AggregateTypes.Aux[T, AggrColumns, AggrColumnTypes],
      ...
      val aggCols: Seq[Column] =
        mapAny(aggrColumns)(x => new Column(x.asInstanceOf[TypedAggregate[_, _]].expr))
      val tmp = ds
        .dataset
        .toDF()
