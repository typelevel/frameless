  ...
  object agg extends ProductArgs {
    ...
    def applyProduct[TC <: HList, C <: HList, OptK <: HList, Out0 <: HList, Out1](columns: TC)(
        ...
        i5: Prepend.Aux[
          ...
          C,
          Out0
        ], // concatenates Option columns with those resulting from applying agg function
...
private[ops] abstract class RelationalGroups1Ops[K1, V](
  ...
  protected def underlying
      : RelationalGroupsOps[V, ::[TypedColumn[V, K1], HNil], ::[K1, HNil], Tuple1[K1]]
  ...
  def agg[U1, U2](
      ...
      c2: TypedAggregate[V, U2]): TypedDataset[(Option[K1], U1, U2)] = {
  ...
  def agg[U1, U2, U3](
      ...
      c3: TypedAggregate[V, U3]): TypedDataset[(Option[K1], U1, U2, U3)] = {
  ...
  def agg[U1, U2, U3, U4](
      ...
      c4: TypedAggregate[V, U4]): TypedDataset[(Option[K1], U1, U2, U3, U4)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder; implicit val e3 = c3.uencoder;
  ...
  def agg[U1, U2, U3, U4, U5](
      ...
      c5: TypedAggregate[V, U5]): TypedDataset[(Option[K1], U1, U2, U3, U4, U5)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder; implicit val e3 = c3.uencoder;
...
private[ops] abstract class RelationalGroups2Ops[K1, K2, V](
    ...
    g1: TypedColumn[V, K1],
    g2: TypedColumn[V, K2]) {
  protected def underlying: RelationalGroupsOps[
    V,
    ::[TypedColumn[V, K1], ::[TypedColumn[V, K2], HNil]],
    ::[K1, ::[K2, HNil]],
    (K1, K2)]
  private implicit def eg1 = g1.uencoder
  ...
  def agg[U1, U2](
      c1: TypedAggregate[V, U1],
      c2: TypedAggregate[V, U2]): TypedDataset[(Option[K1], Option[K2], U1, U2)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder
    underlying.agg(c1, c2)
  }
  ...
  def agg[U1, U2, U3](
      c1: TypedAggregate[V, U1],
      c2: TypedAggregate[V, U2],
      c3: TypedAggregate[V, U3]): TypedDataset[(Option[K1], Option[K2], U1, U2, U3)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder; implicit val e3 = c3.uencoder
    underlying.agg(c1, c2, c3)
  }
  ...
  def agg[U1, U2, U3, U4](
      ...
      c2: TypedAggregate[V, U2],
      c3: TypedAggregate[V, U3],
      c4: TypedAggregate[V, U4]): TypedDataset[(Option[K1], Option[K2], U1, U2, U3, U4)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder; implicit val e3 = c3.uencoder;
    implicit val e4 = c4.uencoder
    underlying.agg(c1, c2, c3, c4)
  }
  ...
  def agg[U1, U2, U3, U4, U5](
      ...
      c3: TypedAggregate[V, U3],
      c4: TypedAggregate[V, U4],
      c5: TypedAggregate[V, U5]): TypedDataset[(Option[K1], Option[K2], U1, U2, U3, U4, U5)] = {
    implicit val e1 = c1.uencoder; implicit val e2 = c2.uencoder; implicit val e3 = c3.uencoder;
    implicit val e4 = c4.uencoder; implicit val e5 = c5.uencoder
    underlying.agg(c1, c2, c3, c4, c5)
  }
...
class Cube2Ops[K1, K2, V](self: TypedDataset[V], g1: TypedColumn[V, K1], g2: TypedColumn[V, K2])
    extends RelationalGroups2Ops(self, g1, g2) {
