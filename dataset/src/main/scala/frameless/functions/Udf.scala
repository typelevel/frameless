...
trait Udf {
   ...
   * apache/spark
   */
  def udf[T, A, R: TypedEncoder](f: A => R): TypedColumn[T, A] => TypedColumn[T, R] = { u =>
  ...
  def udf[T, A1, A2, A3, A4, R: TypedEncoder](f: (A1, A2, A3, A4) => R): (
      ...
      TypedColumn[T, A2],
      TypedColumn[T, A3],
      TypedColumn[T, A4]) => TypedColumn[T, R] = {
    case us =>
      val scalaUdf = FramelessUdf(f, us.toList[UntypedExpression[T]], TypedEncoder[R])
      new TypedColumn[T, R](scalaUdf)
  }
  ...
  def udf[T, A1, A2, A3, A4, A5, R: TypedEncoder](f: (A1, A2, A3, A4, A5) => R): (
      ...
      TypedColumn[T, A3],
      TypedColumn[T, A4],
      TypedColumn[T, A5]) => TypedColumn[T, R] = {
    case us =>
      val scalaUdf = FramelessUdf(f, us.toList[UntypedExpression[T]], TypedEncoder[R])
      new TypedColumn[T, R](scalaUdf)
  }
...
case class FramelessUdf[T, R](
  ...
  override def doGenCode(ctx: CodegenContext, ev: ExprCode): ExprCode = {
    ...
    val internalExpr =
      Spark2_4_LambdaVariable(internalTerm, internalNullTerm, rencoder.jvmRepr, true)
