...
trait NonAggregateFunctions {
  ...
  def sha2[T](
      ...
      numBits: Int): column.ThisType[T, String] =
  ...
  def conv[T](
      ...
      fromBase: Int,
      toBase: Int): column.ThisType[T, String] =
  ...
  def ceil[A, B, T](column: AbstractTypedColumn[T, A])(
      implicit i0: CatalystRound[A, B],
      i1: TypedEncoder[B]): column.ThisType[T, B] =
  ...
  def shiftRightUnsigned[A, B, T](column: AbstractTypedColumn[T, A], numBits: Int)(
      implicit i0: CatalystBitShift[A, B],
      i1: TypedEncoder[B]): column.ThisType[T, B] =
  ...
  def arrayContains[C[_]: CatalystCollection, A, T](
      ...
      value: A): column.ThisType[T, Boolean] =
  ...
  def atan2[A, B, T](l: TypedColumn[T, A], r: TypedColumn[T, B])(
      ...
      i1: CatalystCast[B, Double]): TypedColumn[T, Double] =
  ...
  def atan2[A, B, T](l: TypedAggregate[T, A], r: TypedAggregate[T, B])(
      implicit i0: CatalystCast[A, Double],
      i1: CatalystCast[B, Double]): TypedAggregate[T, Double] =
    r.typed(sparkFunctions.atan2(l.cast[Double].untyped, r.cast[Double].untyped))
   ...
   * apache/spark
   */
  def md5[T, A](column: AbstractTypedColumn[T, A])(
      implicit i0: TypedEncoder[A]): column.ThisType[T, String] =
   ...
   * apache/spark
   */
  def factorial[T](column: AbstractTypedColumn[T, Long])(
      implicit i0: TypedEncoder[Long]): column.ThisType[T, Long] =
  ...
  def bitwiseNOT[A: CatalystBitwise, T](
      column: AbstractTypedColumn[T, A]): column.ThisType[T, A] =
  ...
  def when[T, A](
      ...
      value: AbstractTypedColumn[T, A]): When[T, A] =
  ...
  def levenshtein[T](
      ...
      r: TypedColumn[T, String]): TypedColumn[T, Int] =
  ...
  def levenshtein[T](
      ...
      r: TypedAggregate[T, String]): TypedAggregate[T, Int] =
    l.typed(sparkFunctions.levenshtein(l.untyped, r.untyped))
