...
trait UnaryFunctions {
  ...
  def size[T, A, V[_]: CatalystSizableCollection](
      column: TypedColumn[T, V[A]]): TypedColumn[T, Int] =
  ...
  def sortAscending[T, A: Ordering, V[_]: CatalystSortableCollection](
      column: TypedColumn[T, V[A]]): TypedColumn[T, V[A]] =
    new TypedColumn[T, V[A]](
      implicitly[CatalystSortableCollection[V]].sortOp(column.untyped, sortAscending = true))(
      column.uencoder)
  ...
  def sortDescending[T, A: Ordering, V[_]: CatalystSortableCollection](
      column: TypedColumn[T, V[A]]): TypedColumn[T, V[A]] =
    new TypedColumn[T, V[A]](
      implicitly[CatalystSortableCollection[V]].sortOp(column.untyped, sortAscending = false))(
      column.uencoder)
  ...
  def explode[T, A: TypedEncoder, V[_]: CatalystExplodableCollection](
      column: TypedColumn[T, V[A]]): TypedColumn[T, A] =
