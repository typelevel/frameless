 ...
 *   - Auto: Choose automatically for task: If numTrees == 1, set to All If numTrees > 1
 *     (forest), set to Sqrt for classification and to OneThird for regression.
 ...
 *
 * @see
 *   <a href="http://www.stat.berkeley.edu/~breiman/randomforest2001.pdf">Breiman (2001)</a>
 * @see
 *   <a href="http://www.stat.berkeley.edu/~breiman/Using_random_forests_V3.1.pdf"> Breiman
 *   manual for random forests</a>
 */
