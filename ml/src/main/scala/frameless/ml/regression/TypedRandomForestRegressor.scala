...
final class TypedRandomForestRegressor[Inputs] private[ml] (
  ...
  def setMinInfoGain(value: Double): TypedRandomForestRegressor[Inputs] = copy(
    rf.setMinInfoGain(value))
  def setMinInstancesPerNode(value: Int): TypedRandomForestRegressor[Inputs] = copy(
    rf.setMinInstancesPerNode(value))
  def setMaxMemoryInMB(value: Int): TypedRandomForestRegressor[Inputs] = copy(
    rf.setMaxMemoryInMB(value))
  def setSubsamplingRate(value: Double): TypedRandomForestRegressor[Inputs] = copy(
    rf.setSubsamplingRate(value))
  def setFeatureSubsetStrategy(
      value: FeatureSubsetStrategy): TypedRandomForestRegressor[Inputs] =
...
object TypedRandomForestRegressor {
  ...
  def apply[Inputs](
      implicit
      inputsChecker: TreesInputsChecker[Inputs]): TypedRandomForestRegressor[Inputs] = {
